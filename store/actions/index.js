import { loadInitialDataAction, addDeckAction, deleteDeckAction, addQuestionAction } from './actions';
...
export const addQuestion = (deck, question) => dispatch => {
    ...
    const key = newDeck.title;
    return _submitDeckEntry(newDeck, key)
        .then(() => dispatch(addQuestionAction(key, question)));
};
